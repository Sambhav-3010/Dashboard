...
export default function Header() {
  ...
  const handleViewChange = (view: "dashboard" | "add-product" | "inventory") => {
            ...
            <nav className="flex space-x-2">
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors duration-200 ${
                  state.currentView === "dashboard" ? "bg-amber-100 text-amber-700" : "text-gray-600 hover:bg-gray-100"
                }`}
              >
              ...
              <button
                onClick={() => handleViewChange("add-product")}
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors duration-200 ${
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors duration-200 ${
                  state.currentView === "inventory" ? "bg-amber-100 text-amber-700" : "text-gray-600 hover:bg-gray-100"
                }`}
              >
